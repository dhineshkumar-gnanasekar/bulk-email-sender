    ...
    <div class="flex w-screen h-full justify-between px-2">
      ...
      <div class="my-auto">
        ...
        >
          ...
          <div
            class="absolute right-[30px] top-0 transform -translate-x-1/2 -translate-y-1/2 rotate-45 w-4 h-4 border-l border-t border-b-0 border-r-0 border-gray-400 bg-gray-800"
          ></div>
        </div>
      </div>
    </div>
